...
export default class UplodafileSecurities extends Component {
    constructor(props) {
        super(props);
        this.state = {
            file: null,
    ...
    fileUpload(file) {
        const url = 'http://localhost:8080/uploadSecurities';
        ...
        }).catch(err => {this.sendMessageError("File does not upload success", "danger");})
    }
